...
import { createContext, useContext, useEffect, useMemo, useRef, useState as useState2 } from "react";
import {
  ReactFlow,
  Background,
  Controls,
...
import { AlertTriangle, Plus, Loader2 as Loader22 } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs("div", { className: `relative ${className}`, children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          isExporting ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsx(Download, { className: "w-4 h-4" }),
    ...
    isDropdownOpen && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "absolute right-0 z-20 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-2", children: [
          /* @__PURE__ */ jsx("div", { className: "px-3 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wide dark:text-gray-400", children: "Export Options" }),
          exportOptions.map((option) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 mt-0.5", children: isCurrentlyExporting ? /* @__PURE__ */ jsx(Loader2, { className: "w-4 h-4 animate-spin text-blue-500" }) : /* @__PURE__ */ jsx(Icon, { className: "w-4 h-4 text-gray-500 dark:text-gray-400" }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsx("div", { className: "font-medium text-gray-900 dark:text-gray-100", children: option.label }),
                    /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: option.description })
                  ] })
                ]
              },
              option.type
...
function ExplorerNode({ data, id }) {
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx2(Handle, { type: "target", id: "target-left", position: Position.Left, style: { background: "#6b7280", width: 8, height: 8, top: "40%" } }),
        /* @__PURE__ */ jsx2(Handle, { type: "source", id: "source-left", position: Position.Left, style: { background: "#06b6d4", width: 8, height: 8, top: "60%" } }),
        isLoading && /* @__PURE__ */ jsx2(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx2(Loader22, { size: 20, style: { color: "#60a5fa", animation: "spin 1s linear infinite" } })
          }
        ),
        /* @__PURE__ */ jsxs2("div", { style: { display: "flex", alignItems: "center", gap: 4, marginBottom: 4, flexWrap: "wrap" }, children: [
          node.is_root && /* @__PURE__ */ jsx2(
            "span",
            {
              style: {
                fontSize: 9,
          ...
          node.is_stopped && /* @__PURE__ */ jsx2(AlertTriangle, { size: 11, style: { color: "#f59e0b", flexShrink: 0 } }),
          primaryTag && /* @__PURE__ */ jsx2(
            "span",
            {
              style: {
                fontSize: 9,
        ...
        /* @__PURE__ */ jsxs2("div", { style: { display: "flex", alignItems: "center", gap: 4, marginTop: 4 }, children: [
          ...
          /* @__PURE__ */ jsxs2("span", { style: { fontSize: 9, color: isDark ? "#64748b" : "#94a3b8" }, children: [
            "d",
            node.depth
          ] })
        ] }),
        !node.is_root && !node.is_stopped && onNodeExpand && /* @__PURE__ */ jsx2(
          "button",
          {
            style: {
              position: "absolute",
            ...
            children: /* @__PURE__ */ jsx2(Plus, { size: 11 })
          }
        ),
        !node.is_root && onNodeDelete && /* @__PURE__ */ jsx2(
          "button",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ jsx2(Handle, { type: "source", id: "source-right", position: Position.Right, style: { background: "#8b5cf6", width: 8, height: 8, top: "40%" } }),
        /* @__PURE__ */ jsx2(Handle, { type: "target", id: "target-right", position: Position.Right, style: { background: "#6b7280", width: 8, height: 8, top: "60%" } })
      ]
    }
  );
}
...
function AmountEdge({
  ...
  return /* @__PURE__ */ jsxs2(Fragment2, { children: [
    /* @__PURE__ */ jsx2(BaseEdge, { id, path, style, markerEnd }),
    label && /* @__PURE__ */ jsx2(EdgeLabelRenderer, { children: /* @__PURE__ */ jsx2(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: /* @__PURE__ */ jsxs2(
          "div",
          {
            ...
            children: [
              typeof edgeData?.token === "string" && /* @__PURE__ */ jsx2(TokenIcon, { token: edgeData.token }),
              label
            ]
          }
        )
...
function GraphExplorer({
  ...
  return /* @__PURE__ */ jsxs2("div", { ref: containerRef, style: { width: "100%", height: "100%", position: "relative" }, children: [
    /* @__PURE__ */ jsx2(ExplorerCallbacksCtx.Provider, { value: ctxValue, children: /* @__PURE__ */ jsxs2(
      ReactFlow,
      {
        nodes,
        edges,
        ...
        children: [
          /* @__PURE__ */ jsx2(Background, { color: isDark ? "#374151" : "#d1d5db", gap: 20 }),
          ...
          /* @__PURE__ */ jsx2(Panel, { position: "top-right", children: /* @__PURE__ */ jsxs2("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
            /* @__PURE__ */ jsx2(
              ExportToolbar,
              {
                nodes: apiNodes,
...
import { useEffect as useEffect2, useRef as useRef2, useMemo as useMemo2, useCallback, useState as useState3 } from "react";
  ...
  return /* @__PURE__ */ jsxs3("div", { style: { position: "relative", width: "100%", height: "100%" }, children: [
    loading && /* @__PURE__ */ jsxs3(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx3(Loader23, { size: 36, style: { color: "#60a5fa", animation: "spin 1s linear infinite" } }),
          /* @__PURE__ */ jsx3("span", { style: { color: "#94a3b8", fontSize: 13 }, children: "Exploring graph\u2026" })
        ]
      }
    ),
    /* @__PURE__ */ jsx3("div", { ref: containerRef, style: { width: "100%", height: "100%", background: colors.bg } }),
    /* @__PURE__ */ jsxs3(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ jsx3("button", { title: "Zoom In", onClick: zoomIn, style: controlBtnStyle(isDark), children: "+" }),
          /* @__PURE__ */ jsx3("button", { title: "Zoom Out", onClick: zoomOut, style: controlBtnStyle(isDark), children: "\u2212" }),
          /* @__PURE__ */ jsx3("button", { title: "Fit View", onClick: handleFitView, style: controlBtnStyle(isDark), children: "\u22A1" })
        ]
      }
    ),
    (stats || nodes.length > 0) && /* @__PURE__ */ jsx3(
      "div",
      {
        style: {
          position: "absolute",
...
import { Search, X, Hash, Wallet, AlertTriangle as AlertTriangle2 } from "lucide-react";
...
function SearchBar({
  ...
  const getResultIcon = (result) => {
    if (result.type === "node") {
      ...
      if (result.matchField === "risk_level") {
        return /* @__PURE__ */ jsx4(AlertTriangle2, { className: "w-4 h-4 text-amber-500" });
      }
      return /* @__PURE__ */ jsx4(Wallet, { className: "w-4 h-4 text-blue-500" });
    } else {
      return /* @__PURE__ */ jsx4(Hash, { className: "w-4 h-4 text-green-500" });
    }
  };
  ...
  return /* @__PURE__ */ jsxs4("div", { className: `relative ${className}`, children: [
    /* @__PURE__ */ jsxs4("div", { className: "relative", children: [
      /* @__PURE__ */ jsx4(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" }),
      /* @__PURE__ */ jsx4(
        "input",
        {
          type: "text",
    ...
    (isOpen || showSearchHints) && /* @__PURE__ */ jsxs4("div", { className: "absolute z-30 w-full mt-2 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700", children: [
      showSearchHints && /* @__PURE__ */ jsxs4("div", { className: "p-3", children: [
        /* @__PURE__ */ jsx4("div", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 dark:text-gray-400", children: "Search Tips" }),
        /* @__PURE__ */ jsxs4("div", { className: "space-y-1 text-xs text-gray-600 dark:text-gray-400", children: [
          /* @__PURE__ */ jsx4("div", { children: "\u2022 Enter at least 2 characters to search" }),
          /* @__PURE__ */ jsx4("div", { children: "\u2022 Search addresses: 0x1234... or TN3W4H..." }),
          /* @__PURE__ */ jsx4("div", { children: "\u2022 Search risk levels: high, medium, low" }),
          /* @__PURE__ */ jsx4("div", { children: "\u2022 Search entity tags: exchange, defi, etc." }),
          /* @__PURE__ */ jsx4("div", { children: "\u2022 Search amounts: 100 USDT, 1.5 ETH" })
        ] })
      ] }),
      isOpen && searchResults.length === 0 && /* @__PURE__ */ jsxs4("div", { className: "p-4 text-center text-sm text-gray-500 dark:text-gray-400", children: [
        'No results found for "',
        query,
        '"'
      ] }),
      isOpen && searchResults.length > 0 && /* @__PURE__ */ jsx4(Fragment3, { children: /* @__PURE__ */ jsxs4("div", { className: "p-2", children: [
        /* @__PURE__ */ jsxs4("div", { className: "px-2 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wide dark:text-gray-400", children: [
          searchResults.length,
          " result",
          searchResults.length > 1 ? "s" : "",
          queryType !== "general" && ` \u2022 ${queryType} detected`
        ] }),
        /* @__PURE__ */ jsx4("div", { className: "mt-1 space-y-1", children: searchResults.map((result, index) => {
            ...
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs4("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsx4("div", { className: "font-medium text-gray-900 dark:text-gray-100", children: primary }),
                  secondary && /* @__PURE__ */ jsx4("div", { className: "text-xs text-gray-500 dark:text-gray-400 truncate", children: secondary })
                ] }),
                /* @__PURE__ */ jsx4("div", { className: "text-xs text-gray-400 dark:text-gray-500", children: result.type })
              ]
            },
            index
          );
...
import { Filter, DollarSign, Layers, AlertTriangle as AlertTriangle3, ChevronDown, ChevronUp } from "lucide-react";
...
function FilterPanel({
  ...
  return /* @__PURE__ */ jsxs5("div", { className: `bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 ${className}`, children: [
    /* @__PURE__ */ jsxs5("div", { className: "flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-700", children: [
      /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx5(Filter, { className: "w-4 h-4 text-gray-500" }),
        /* @__PURE__ */ jsx5("span", { className: "font-medium text-gray-900 dark:text-gray-100", children: "Filters" }),
        activeFilterCount > 0 && /* @__PURE__ */ jsx5("span", { className: "px-2 py-0.5 text-xs font-medium text-white bg-blue-500 rounded-full", children: activeFilterCount })
      ] }),
      /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsx5(
          "button",
          {
            ...
            children: isExpanded ? /* @__PURE__ */ jsx5(ChevronUp, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx5(ChevronDown, { className: "w-4 h-4" })
          }
        )
      ] })
    ] }),
    isExpanded && /* @__PURE__ */ jsxs5("div", { className: "p-4 space-y-4", children: [
      /* @__PURE__ */ jsxs5("div", { children: [
        /* @__PURE__ */ jsx5("label", { className: "block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2", children: "Risk Levels" }),
        /* @__PURE__ */ jsx5("div", { className: "flex flex-wrap gap-2", children: RISK_LEVELS.map((risk) => /* @__PURE__ */ jsxs5(
          "button",
          {
            onClick: () => {
            ...
            children: [
              /* @__PURE__ */ jsx5(AlertTriangle3, { className: "w-3 h-3" }),
              risk.toUpperCase()
            ]
          },
          risk
      ...
      availableOptions.chains.length > 0 && /* @__PURE__ */ jsxs5("div", { children: [
        /* @__PURE__ */ jsx5("label", { className: "block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2", children: "Chains" }),
        /* @__PURE__ */ jsx5("div", { className: "flex flex-wrap gap-2", children: availableOptions.chains.map((chain) => /* @__PURE__ */ jsxs5(
          "button",
          {
            onClick: () => {
            ...
            children: [
              /* @__PURE__ */ jsx5(Layers, { className: "w-3 h-3" }),
              chain
            ]
          },
          chain
      ...
      /* @__PURE__ */ jsxs5("div", { children: [
        /* @__PURE__ */ jsxs5("label", { className: "block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2", children: [
          "Depth Range: ",
          filter.depthRange[0],
          " - ",
          filter.depthRange[1]
      ...
      /* @__PURE__ */ jsxs5("div", { children: [
        ...
        /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx5(DollarSign, { className: "w-4 h-4 text-gray-500" }),
          /* @__PURE__ */ jsx5(
            "input",
            {
              type: "range",
      ...
      availableOptions.tokens.length > 0 && /* @__PURE__ */ jsxs5("div", { children: [
        /* @__PURE__ */ jsx5("label", { className: "block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2", children: "Tokens" }),
        /* @__PURE__ */ jsxs5("div", { className: "flex flex-wrap gap-2", children: [
          availableOptions.tokens.slice(0, 10).map((token) => /* @__PURE__ */ jsx5(
            "button",
            {
              onClick: () => {
          ...
          availableOptions.tokens.length > 10 && /* @__PURE__ */ jsxs5("span", { className: "px-3 py-1 text-xs text-gray-500", children: [
            "+",
      ...
      /* @__PURE__ */ jsxs5("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxs5("label", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx5(
            "input",
            {
              type: "checkbox",
          ...
          /* @__PURE__ */ jsx5("span", { className: "text-sm text-gray-900 dark:text-gray-100", children: "Show only root nodes" })
        ] }),
        /* @__PURE__ */ jsxs5("label", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx5(
            "input",
          ...
          /* @__PURE__ */ jsx5("span", { className: "text-sm text-gray-900 dark:text-gray-100", children: "Show only stopped nodes" })
        ] }),
        /* @__PURE__ */ jsxs5("label", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx5(
            "input",
          ...
          /* @__PURE__ */ jsx5("span", { className: "text-sm text-gray-900 dark:text-gray-100", children: "Hide untagged nodes" })
        ] })
      ] })
    ] })
  ] });
...
import React6, { useState as useState6, useMemo as useMemo5 } from "react";
...
function GraphControlPanel({
  ...
  const [filter, setFilter] = useState6(DEFAULT_FILTER);
  ...
  return /* @__PURE__ */ jsxs6("div", { className: `space-y-4 ${className}`, children: [
    ...
    (filterStats.nodes.hidden > 0 || filterStats.edges.hidden > 0) && /* @__PURE__ */ jsxs6("div", { className: "p-3 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-900/20 dark:border-blue-800", children: [
      /* @__PURE__ */ jsx6("div", { className: "text-sm font-medium text-blue-900 dark:text-blue-100 mb-1", children: "Filter Applied" }),
      /* @__PURE__ */ jsxs6("div", { className: "text-xs text-blue-700 dark:text-blue-300 space-y-0.5", children: [
        filterStats.nodes.hidden > 0 && /* @__PURE__ */ jsxs6("div", { children: [
          "Showing ",
        ...
        filterStats.edges.hidden > 0 && /* @__PURE__ */ jsxs6("div", { children: [
          "Showing ",
    ...
    selectedNode && /* @__PURE__ */ jsxs6("div", { className: "p-3 bg-green-50 border border-green-200 rounded-lg dark:bg-green-900/20 dark:border-green-800", children: [
      /* @__PURE__ */ jsx6("div", { className: "text-sm font-medium text-green-900 dark:text-green-100 mb-1", children: "Selected Node" }),
      /* @__PURE__ */ jsxs6("div", { className: "text-xs text-green-700 dark:text-green-300 space-y-0.5", children: [
        /* @__PURE__ */ jsxs6("div", { className: "font-mono", children: [
        ...
        selectedNode.tags.length > 0 && /* @__PURE__ */ jsxs6("div", { children: [
          "Tags: ",
...
import { useState as useState8, useEffect as useEffect4, useCallback as useCallback3 } from "react";
import { Wifi, WifiOff, Play, Pause, AlertCircle, Bell, BellOff } from "lucide-react";

// src/hooks/useWebSocket.ts
import { useState as useState7, useEffect as useEffect3, useCallback as useCallback2, useRef as useRef3 } from "react";
function useWebSocket(config) {
  ...
  const reconnectTimeoutRef = useRef3(null);
  const heartbeatIntervalRef = useRef3(null);
  ...
  const sendMessage = useCallback2((message) => {
    if (wsRef.current?.readyState === WebSocket.OPEN) {
  ...
  const subscribe = useCallback2((channel, params) => {
    return sendMessage({
      type: "subscribe",
      channel,
      params
  ...
  const unsubscribe = useCallback2((channel) => {
    return sendMessage({
      type: "unsubscribe",
      channel
    });
...
function RealTimeManager({
  ...
  const [isEnabled, setIsEnabled] = useState8(false);
  const [notifications, setNotifications] = useState8(true);
  const [updateCount, setUpdateCount] = useState8(0);
  const [lastUpdate, setLastUpdate] = useState8(null);
  const [recentUpdates, setRecentUpdates] = useState8([]);
  const handleWebSocketMessage = useCallback3((data) => {
    const update = {
  ...
  return /* @__PURE__ */ jsxs7("div", { className: `bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 ${className}`, children: [
    /* @__PURE__ */ jsxs7("div", { className: "flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-700", children: [
      /* @__PURE__ */ jsxs7("div", { className: "flex items-center gap-2", children: [
        state.isConnected && isEnabled ? /* @__PURE__ */ jsx7(Wifi, { className: "w-4 h-4 text-green-500" }) : /* @__PURE__ */ jsx7(WifiOff, { className: "w-4 h-4 text-gray-400" }),
        /* @__PURE__ */ jsx7("span", { className: "font-medium text-gray-900 dark:text-gray-100", children: "Real-time Updates" }),
        /* @__PURE__ */ jsx7("span", { className: `text-xs font-medium ${status.color}`, children: status.text })
      ] }),
      /* @__PURE__ */ jsxs7("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsx7(
          "button",
          {
            ...
            children: notifications ? /* @__PURE__ */ jsx7(Bell, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx7(BellOff, { className: "w-4 h-4" })
          }
        ),
        /* @__PURE__ */ jsxs7(
          "button",
          {
            ...
            children: [
              isEnabled ? /* @__PURE__ */ jsx7(Pause, { className: "w-3 h-3" }) : /* @__PURE__ */ jsx7(Play, { className: "w-3 h-3" }),
    ...
    /* @__PURE__ */ jsxs7("div", { className: "p-3", children: [
      state.error && /* @__PURE__ */ jsxs7("div", { className: "flex items-center gap-2 mb-3 p-2 text-sm text-red-700 bg-red-50 rounded-md dark:bg-red-900/20 dark:text-red-300", children: [
        /* @__PURE__ */ jsx7(AlertCircle, { className: "w-4 h-4" }),
        state.error,
        state.reconnectAttempts > 0 && /* @__PURE__ */ jsxs7("span", { className: "ml-1", children: [
          "(Retry ",
      ...
      /* @__PURE__ */ jsxs7("div", { className: "grid grid-cols-2 gap-4 text-sm", children: [
        /* @__PURE__ */ jsxs7("div", { children: [
          /* @__PURE__ */ jsx7("div", { className: "text-gray-500 dark:text-gray-400", children: "Updates received" }),
          /* @__PURE__ */ jsx7("div", { className: "font-medium text-gray-900 dark:text-gray-100", children: updateCount })
        ] }),
        /* @__PURE__ */ jsxs7("div", { children: [
          /* @__PURE__ */ jsx7("div", { className: "text-gray-500 dark:text-gray-400", children: "Last update" }),
          /* @__PURE__ */ jsx7("div", { className: "font-medium text-gray-900 dark:text-gray-100", children: lastUpdate ? lastUpdate.toLocaleTimeString() : "None" })
        ] })
      ] }),
      watchedAddresses.length > 0 && /* @__PURE__ */ jsxs7("div", { className: "mt-3", children: [
        /* @__PURE__ */ jsxs7("div", { className: "text-xs text-gray-500 dark:text-gray-400 mb-1", children: [
          "Watching ",
          watchedAddresses.length,
          " addresses"
        ] }),
        /* @__PURE__ */ jsxs7("div", { className: "space-y-1", children: [
          watchedAddresses.slice(0, 3).map((address) => /* @__PURE__ */ jsxs7("div", { className: "flex items-center gap-2 text-xs", children: [
            /* @__PURE__ */ jsx7("div", { className: `w-2 h-2 rounded-full ${isEnabled && state.isConnected ? "bg-green-400" : "bg-gray-300"}` }),
            /* @__PURE__ */ jsxs7("code", { className: "text-gray-600 dark:text-gray-300", children: [
              address.slice(0, 8),
              "...",
              address.slice(-6)
            ] })
          ] }, address)),
          watchedAddresses.length > 3 && /* @__PURE__ */ jsxs7("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: [
            "+",
      ...
      recentUpdates.length > 0 && /* @__PURE__ */ jsxs7("div", { className: "mt-3", children: [
        /* @__PURE__ */ jsx7("div", { className: "text-xs text-gray-500 dark:text-gray-400 mb-1", children: "Recent updates" }),
        /* @__PURE__ */ jsx7("div", { className: "space-y-1 max-h-24 overflow-y-auto", children: recentUpdates.slice(0, 5).map((update, index) => /* @__PURE__ */ jsxs7("div", { className: "flex items-center justify-between text-xs", children: [
          /* @__PURE__ */ jsx7("span", { className: "text-gray-600 dark:text-gray-300", children: update.type.replace("_", " ") }),
          /* @__PURE__ */ jsx7("span", { className: "text-gray-500 dark:text-gray-400", children: new Date(update.timestamp).toLocaleTimeString() })
        ] }, index)) })
      ] })
    ] })
  ] });
...
import { useState as useState9, useMemo as useMemo6 } from "react";
import { Brain, AlertTriangle as AlertTriangle4, Eye, EyeOff, Settings, ChevronDown as ChevronDown2, ChevronUp as ChevronUp2 } from "lucide-react";
...
function ClusterAnalysis({
  ...
  const [selectedCluster, setSelectedCluster] = useState9(null);
  const [highlightedClusters, setHighlightedClusters] = useState9(/* @__PURE__ */ new Set());
  const [clusteringOptions, setClusteringOptions] = useState9({
    minClusterSize: 3,
    maxDistance: 0.7,
    riskThreshold: 0.6,
    valueThreshold: 1e3,
  ...
  const { clusters, anomalies } = useMemo6(() => {
  ...
  return /* @__PURE__ */ jsxs8("div", { className: `bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 ${className}`, children: [
    /* @__PURE__ */ jsxs8("div", { className: "flex items-center justify-between p-3 border-b border-gray-200 dark:border-gray-700", children: [
      /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx8(Brain, { className: "w-4 h-4 text-purple-500" }),
        /* @__PURE__ */ jsx8("span", { className: "font-medium text-gray-900 dark:text-gray-100", children: "Cluster Analysis" }),
        clusters.length > 0 && /* @__PURE__ */ jsx8("span", { className: "px-2 py-0.5 text-xs font-medium text-white bg-purple-500 rounded-full", children: clusters.length })
      ] }),
      /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsx8(
          "button",
          {
            onClick: () => setIsExpanded(!isExpanded),
            className: "p-1 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200",
            children: isExpanded ? /* @__PURE__ */ jsx8(ChevronUp2, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx8(ChevronDown2, { className: "w-4 h-4" })
          }
        )
      ] })
    ] }),
    showSettings && /* @__PURE__ */ jsxs8("div", { className: "p-3 bg-gray-50 border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700", children: [
      /* @__PURE__ */ jsx8("div", { className: "text-sm font-medium text-gray-900 dark:text-gray-100 mb-2", children: "Clustering Settings" }),
      /* @__PURE__ */ jsxs8("div", { className: "grid grid-cols-2 gap-3 text-sm", children: [
        /* @__PURE__ */ jsxs8("div", { children: [
          /* @__PURE__ */ jsx8("label", { className: "block text-xs text-gray-500 dark:text-gray-400 mb-1", children: "Min Cluster Size" }),
          /* @__PURE__ */ jsx8(
            "input",
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxs8("div", { children: [
          /* @__PURE__ */ jsx8("label", { className: "block text-xs text-gray-500 dark:text-gray-400 mb-1", children: "Similarity Threshold" }),
          /* @__PURE__ */ jsx8(
            "input",
            {
              type: "range",
          ...
          /* @__PURE__ */ jsx8("div", { className: "text-xs text-gray-500", children: clusteringOptions.maxDistance })
        ] }),
        /* @__PURE__ */ jsx8("div", { className: "col-span-2", children: /* @__PURE__ */ jsxs8("label", { className: "flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300", children: [
          /* @__PURE__ */ jsx8(
            "input",
            {
              type: "checkbox",
    ...
    isExpanded && /* @__PURE__ */ jsxs8("div", { className: "p-3", children: [
      /* @__PURE__ */ jsxs8("div", { className: "grid grid-cols-3 gap-4 mb-4 text-sm", children: [
        /* @__PURE__ */ jsxs8("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx8("div", { className: "font-medium text-purple-600 dark:text-purple-400", children: clusters.length }),
          /* @__PURE__ */ jsx8("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Clusters" })
        ] }),
        /* @__PURE__ */ jsxs8("div", { className: "text-center", children: [
          /* @__PURE__ */ jsx8("div", { className: "font-medium text-orange-600 dark:text-orange-400", children: analysisStats.highSeverityAnomalies }),
          /* @__PURE__ */ jsx8("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: "High Risk" })
        ] }),
        /* @__PURE__ */ jsxs8("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxs8("div", { className: "font-medium text-gray-600 dark:text-gray-400", children: [
            analysisStats.clusteringRate.toFixed(0),
            "%"
          ] }),
          /* @__PURE__ */ jsx8("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: "Clustered" })
        ] })
      ] }),
      clusters.length > 0 && /* @__PURE__ */ jsxs8("div", { className: "mb-4", children: [
        /* @__PURE__ */ jsx8("div", { className: "text-sm font-medium text-gray-900 dark:text-gray-100 mb-2", children: "Detected Clusters" }),
        /* @__PURE__ */ jsx8("div", { className: "space-y-2 max-h-48 overflow-y-auto", children: clusters.map((cluster) => /* @__PURE__ */ jsxs8(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs8("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsx8("span", { className: "text-sm font-medium text-gray-900 dark:text-gray-100", children: cluster.type.toUpperCase() }),
                  /* @__PURE__ */ jsxs8("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: [
                ...
                /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-1", children: [
                  ...
                  /* @__PURE__ */ jsx8(
                    "button",
                    {
                      ...
                      className: "p-1 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200",
                      children: highlightedClusters.has(cluster.id) ? /* @__PURE__ */ jsx8(EyeOff, { className: "w-3 h-3" }) : /* @__PURE__ */ jsx8(Eye, { className: "w-3 h-3" })
                    }
                  )
                ] })
              ] }),
              /* @__PURE__ */ jsxs8("div", { className: "mt-1 text-xs text-gray-600 dark:text-gray-400", children: [
                "Confidence: ",
      ...
      anomalies.length > 0 && /* @__PURE__ */ jsxs8("div", { children: [
        /* @__PURE__ */ jsx8("div", { className: "text-sm font-medium text-gray-900 dark:text-gray-100 mb-2", children: "Detected Anomalies" }),
        /* @__PURE__ */ jsx8("div", { className: "space-y-2 max-h-48 overflow-y-auto", children: anomalies.map((anomaly, index) => /* @__PURE__ */ jsx8(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs8("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx8(
                  AlertTriangle4,
                  {
                ...
                /* @__PURE__ */ jsxs8("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsx8("div", { className: "text-sm font-medium text-gray-900 dark:text-gray-100", children: anomaly.type.replace("_", " ").toUpperCase() }),
                  /* @__PURE__ */ jsx8("div", { className: "text-xs text-gray-600 dark:text-gray-400 mt-0.5", children: anomaly.description })
                ] })
              ] }),
              /* @__PURE__ */ jsxs8("div", { className: "text-xs text-gray-500 dark:text-gray-400", children: [
      ...
      clusters.length === 0 && anomalies.length === 0 && /* @__PURE__ */ jsxs8("div", { className: "text-center py-6 text-gray-500 dark:text-gray-400", children: [
        /* @__PURE__ */ jsx8(Brain, { className: "w-8 h-8 mx-auto mb-2 opacity-50" }),
        /* @__PURE__ */ jsx8("div", { className: "text-sm", children: "No clusters or anomalies detected" }),
        /* @__PURE__ */ jsx8("div", { className: "text-xs", children: "Try adjusting clustering settings" })
      ] }),
      selectedCluster && /* @__PURE__ */ jsxs8("div", { className: "mt-4 p-3 bg-purple-50 border border-purple-200 rounded-md dark:bg-purple-900/20 dark:border-purple-800", children: [
        /* @__PURE__ */ jsxs8("div", { className: "text-sm font-medium text-purple-900 dark:text-purple-100 mb-2", children: [
          "Cluster Details: ",
          selectedCluster.type.toUpperCase()
        ] }),
        /* @__PURE__ */ jsxs8("div", { className: "text-xs text-purple-700 dark:text-purple-300 space-y-1", children: [
          /* @__PURE__ */ jsxs8("div", { children: [
            "Centroid: ",
